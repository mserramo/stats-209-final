...
match1_1_k = pairmatch(dist1_caliper, controls = 3, data=fludata)
...
match1_to_k_5_exact_copd_sens_data = match1_1_k_5_exact_copd_summary %>% mutate(y = -(outcome.1 - outcome.0)) %>% pull(y)
match1_to_k_5_exact_copd_sens = senmv(match1_to_k_5_exact_copd_sens_data,gamma=3,trim=1)
match1_to_k_5_exact_copd_sense_pv = match1_to_k_5_exact_copd_sens[["pval"]]
